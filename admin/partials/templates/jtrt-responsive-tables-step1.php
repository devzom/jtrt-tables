<?php
$icons_url = plugin_dir_url( __FILE__ ) . '../../css/icons/';
?>
<div id="step1" class="jtrteditorsection jtrteditorshow">
        ...
        <nav id="jteditbottomtoolbar">
            <ul>
                <li id="jtundo" data-jtrt-btnType="undo" title="Undo"><img src="<?php echo $icons_url; ?>undo.png" alt=""></li>
                <li id="jtredo" data-jtrt-btnType="redo" title="Redo"><img src="<?php echo $icons_url; ?>redo.png" alt=""></li>
                <span></span>
                <li class="jtedittexttoolbar" id="jtboldtext" data-jtrt-toolbar-opt="font-weight" data-jtrt-toolbar-opt-val="bold" title="Bold"><img src="<?php echo $icons_url; ?>bold-text.png" alt=""></li>
                <li class="jtedittexttoolbar" id="jtitalictext" data-jtrt-toolbar-opt="font-style" data-jtrt-toolbar-opt-val="italic" title="Italic"><img src="<?php echo $icons_url; ?>italic-text.png" alt=""></li>
                <li class="jtedittexttoolbar" id="jtunderlinetext" data-jtrt-toolbar-opt="text-decoration" data-jtrt-toolbar-opt-val="underline" title="Underline"><img src="<?php echo $icons_url; ?>underline-text.png" alt=""></li>
                <li id="jteditfont" class="jtrt-toolbar-more" title="Edit Font">
                    <img src="<?php echo $icons_url; ?>edit-font.png" alt="">
                    <ul>
                        <div>
                            ...
                            <select id="">
                                <?php
                                    ...
                                    foreach ( $availableFonts as $value ) {
                                        echo sprintf( '<option value="%s">%s</option>', esc_attr( $value ), esc_html( $value ) );
                                    }
                ...
                <li id="jthighlight" class="jtrt-toolbar-more" title="Cell Color"><img src="<?php echo $icons_url; ?>highlight.png" alt="">
                    <ul>
                        <div>
                ...
                <span></span>
                <li class="jtalignbtn" data-align-opt="htLeft" title="Align Text Left"><img src="<?php echo $icons_url; ?>align-left.png" alt=""></li>
                <li class="jtalignbtn" data-align-opt="htCenter" title="Align Text Center"><img src="<?php echo $icons_url; ?>align-center.png" alt=""></li>
                <li class="jtalignbtn" data-align-opt="htRight" title="Align Text Right"><img src="<?php echo $icons_url; ?>align-right.png" alt=""></li>
                <li class="jtalignbtn" data-align-opt="htJustify" title="Justify"><img src="<?php echo $icons_url; ?>align-justify.png" alt=""></li>
                <span></span>
                <li id="jtinsertlink" class="jtrt-toolbar-more" title="Insert Link"><img src="<?php echo $icons_url; ?>link.png" alt="">
                    <ul>
                        <table>
                            <tr>
                ...
                <span></span>
                <li id="jtbordersbtn" class="jtrt-toolbar-more" title="Borders"><img src="<?php echo $icons_url; ?>borders.png" alt="">
                    <ul>
						...
						<button class="jtsetbutton" id="jtsetcellbordersbtn"><?php _e( 'Apply', $text_domain ); ?></button>
                    </ul>
                </li>
                <li id="jthidecolsbtn" class="jtrt-toolbar-more" title="Hide Columns"><img src="<?php echo $icons_url; ?>cols.png" alt="">
                    <ul>
                        <table>
                            <tr>
                ...
                <li id="jtprinttab" title="Print"><img src="<?php echo $icons_url; ?>print.png" alt=""></li>
            </ul>
        </nav>
