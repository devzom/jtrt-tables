				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td><input name="jtrt-table-data[jtShowTableTitle]" type="checkbox" <?php checked( isset( $value['jtShowTableTitle'] ) ); ?>></td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<select id="" name="jtrt-table-data[jtShowTableTitlePos]">
									<?php
										...
										$currentSelected  = $value['jtShowTableTitlePos'] ?? 'topleft';
										foreach ( $positionsTitlejt as $key => $value2 ) {
											printf( '<option value="%s" %s>%s</option>', esc_attr( $key ), selected( $key, $currentSelected, false ), esc_html( $value2 ) );
										}
										?>
								</select>
							</td>
						...
						<tr>
							...
							<td>
								<select id="jtresponsiveoptionscontainerselect" name="jtrt-table-data[jtTableResponsiveStyle]">
									<?php
									$jtTableResponsivestyle          = array(
										'scroll'   => __( 'Classic Scroller' ),
										'footable' => __( 'Column Hiding' ),
										'stack'    => __( 'Column Stacking' ),
									);
									$currentSelectedResponsiveOption = $value['jtTableResponsiveStyle'] ?? 'scroll';
									foreach ( $jtTableResponsivestyle as $key2 => $value3 ) {
										printf( '<option value="%s" %s>%s</option>', esc_attr( $key2 ), selected( $key2, $currentSelectedResponsiveOption, false ), esc_html( $value3 ) );
									}
									?>
								</select>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td><input name="jtrt-table-data[jtTableEnableFilters]" type="checkbox" <?php checked( isset( $value['jtTableEnableFilters'] ) ); ?>></td>
						</tr>
						<tr>
							<td>
							...
							<td><input name="jtrt-table-data[jtTableEnableSorting]" type="checkbox" <?php echo esc_attr( $sortDisabledVal ); ?> <?php checked( isset( $value['jtTableEnableSorting'] ) ); ?>></td>
						</tr>
						<tr>
							<td>
							...
							<td><input name="jtrt-table-data[jtTableEnablePaging]" type="checkbox" <?php checked( isset( $value['jtTableEnablePaging'] ) ); ?>></td>
							<td>
								<input name="jtrt-table-data[jtTableEnablePagingCnt]" type="number" value="<?php echo esc_attr( $value['jtTableEnablePagingCnt'] ?? '10' ); ?>">
							</td>
						</tr>
						<?php if ( $currentSelectedResponsiveOption !== 'footable' ) : ?>
							<tr>
								...
								<td>
									<input name="jtrt-table-data[jtTablePagingMenu]" type="text" value="<?php echo esc_attr( $value['jtTablePagingMenu'] ?? '10,20,50,100' ); ?>">
								</td>
							</tr>
						<?php endif; ?>
						<tr>
							...
							<td><input name="jtrt-table-data[jtTableEnableRowHighlight]" type="checkbox" <?php checked( isset( $value['jtTableEnableRowHighlight'] ) ); ?>></td>
							<td><input class="jtcoloreditpickerOpts" novalidate name="jtrt-table-data[jtTableEnableRowHighlightcol]" type="text" value="<?php echo esc_attr( $value['jtTableEnableRowHighlightcol'] ?? 'rgb(255,255,255)' ); ?>"></td>
						</tr>
						<tr>
							<td>
							...
							<td><input name="jtrt-table-data[jtTableEnableColHighlight]" type="checkbox" <?php checked( isset( $value['jtTableEnableColHighlight'] ) ); ?>></td>
							<td><input class="jtcoloreditpickerOpts" novalidate name="jtrt-table-data[jtTableEnableColHighlightcol]" type="text" value="<?php echo esc_attr( $value['jtTableEnableColHighlightcol'] ?? 'rgb(255,255,255)' ); ?>"></td>
						</tr>
						<tr>
							<td>
							...
							<td><input placeholder="customClass1 my-custom-class" name="jtrt-table-data[jtTableCustomClass]" type="text" value="<?php echo esc_attr( $value['jtTableCustomClass'] ?? '' ); ?>"></td>
						</tr>
					</tbody>
