...
class Jtrt_Responsive_Tables {
	 ...
	 *
	 * - Jtrt_Responsive_Tables_Loader. Orchestrates the hooks of the plugin.
	 * - Jtrt_Responsive_Tables_i18n. Defines internationalization functionality.
	 * - Jtrt_Responsive_Tables_Admin. Defines all hooks for the admin area.
	 * - Jtrt_Responsive_Tables_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Jtrt_Responsive_Tables_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
